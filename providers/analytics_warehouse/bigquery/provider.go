// Package bigquery implements the official Google BigQuery analytics-warehouse Provider.
package bigquery

import (
	connector "github.com/domainry/domainry-connector-sdk"
	internalbigquery "github.com/domainry/domainry-connectors/internal/googlebigquery"
)
...
func New(transport connector.Transport) (connector.Adapter, error) {
	return internalbigquery.New(internalbigquery.Identity{ConnectorKey: ConnectorKey, ProviderKey: ProviderKey, ListTablesHash: ListTables.ContractSHA256, SampleQueryHash: SampleQuery.ContractSHA256, TestConnectionHash: TestConnection.ContractSHA256}, transport)
}
