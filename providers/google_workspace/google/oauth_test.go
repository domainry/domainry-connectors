...
func TestOAuthAuthorizationCodeUsesRegistryAndPrivateHostTransport(t *testing.T) {
	...
	scopes := []string{"https://www.googleapis.com/auth/calendar.readonly", "https://www.googleapis.com/auth/gmail.readonly"}
...
func TestDeclaredConnectionTestScopes(t *testing.T) {
	...
	want := [][]string{{"openid"}, {"https://www.googleapis.com/auth/userinfo.email"}, {"https://www.googleapis.com/auth/userinfo.profile"}}
