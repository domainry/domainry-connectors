...
import (
	...
	web_llm_proxy "github.com/domainry/domainry-connectors/providers/web/llm_proxy"
...
func providerSpecifications() []providerSpec {
	return []providerSpec{
		...
		{importPath: "github.com/domainry/domainry-connectors/providers/web/llm_proxy", packageName: "llmproxy", constructor: providerConstructor(web_llm_proxy.New)},
